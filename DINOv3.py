# ============================================================================
# DINOv3 (ViT-B/16) - CODE COMPLET POUR 120 RACES DE CHIENS
# Modèle : facebook/dinov3-vitb16-pretrain-lvd1689m (Meta AI, 2025)
# Framework : PyTorch + HuggingFace Transformers >= 4.56.0
#
# PRÉREQUIS :
#   pip install torch torchvision transformers>=4.56.0
#   pip install scikit-learn pandas matplotlib pillow
#
# ACCÈS AU MODÈLE (gated) :
#   1. Créer un compte HuggingFace et accepter la licence Meta sur :
#      https://huggingface.co/facebook/dinov3-vitb16-pretrain-lvd1689m
#   2. Générer un token : https://huggingface.co/settings/tokens
#   3. Se connecter : huggingface-cli login
#      ou définir : export HUGGINGFACE_TOKEN=hf_xxxxx
# ============================================================================
